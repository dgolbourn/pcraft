...
provision_client_resources() {
    ...
    find . -type d -print -exec sh -c 'tree "$0" -H "." -L 1 --noreport --dirsfirst --charset utf-8 -I "index.html" -T "Create Mod" --ignore-case --timefmt "%Y%m%d-%H%M%S" -s -D -o "$0/index.html"' {} \;
