...
PATTERN="/opt/data/*.jar"
JARS=( $PATTERN )
echo "CUSTOM_SERVER=${JARS[0]}" >> /opt/percycraft/.env
rm -rf /opt/web/*
...
cp -r /opt/percycraft/mc_init/config/bluemap/opt/webapp.conf /opt/data/config/bluemap/opt/webapp.conf
