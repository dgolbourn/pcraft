...
3. Download the client mods from [Percycraft](http://pcraft.co.uk:8080/mods) and place them in the `/mods` directory of your copy of Minecraft (e.g. somewhere like `%APPDATA%\.minecraft\mods` on Windows)
